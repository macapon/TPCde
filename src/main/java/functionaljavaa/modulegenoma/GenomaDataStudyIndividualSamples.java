...
public Object[] createStudyIndividualSample( String schemaPrefix, Token token, String studyName, Integer indivId, String[] fieldsName, Object[] fieldsValue, Boolean devMode){
    ...
    */
            ...
            if (LPArray.valuePosicInArray(fieldsName, TblsGenomaData.StudyIndividualSample.FLD_ACTIVE.getName())==-1){
               ...
               fieldsValue=LPArray.addValueToArray1D(fieldsValue, GenomaBusinessRules.activateOnCreation(schemaPrefix, LPPlatform.SCHEMA_DATA, TblsGenomaData.StudyIndividualSample.TBL.getName()));
            }else
               fieldsValue[LPArray.valuePosicInArray(fieldsName, TblsGenomaData.StudyIndividualSample.FLD_ACTIVE.getName())] = GenomaBusinessRules.activateOnCreation(schemaPrefix, LPPlatform.SCHEMA_DATA, TblsGenomaData.StudyIndividualSample.TBL.getName());        
    ...
    */
    ...
    public Object[] studyIndividualSampleActivate( String schemaPrefix, Token token, String studyName, Integer indivId, Integer sampleId){
        ...
        if (LPPlatform.LAB_TRUE.equalsIgnoreCase(diagnosesProj[0].toString()))
            GenomaDataAudit.studyAuditAdd(schemaPrefix, token, GenomaDataAudit.StudyAuditEvents.ACTIVATE_STUDY_INDIVIDUAL_SAMPLE.toString(), TblsGenomaData.StudyIndividualSample.TBL.getName(), sampleId.toString(), 
                studyName, null, LPArray.joinTwo1DArraysInOneOf1DString(fieldsName, fieldsValue, ":"), null);
        return diagnosesProj;      
    }    
    ...
    public Object[] studyIndividualSampleUpdate( String schemaPrefix, Token token, String studyName, Integer indivId, Integer sampleId, String[] fieldsName, Object[] fieldsValue){
        ...
        Object[] specialFieldsPresent=GenomaBusinessRules.specialFieldsInUpdateArray(schemaPrefix, LPPlatform.SCHEMA_DATA, TblsGenomaData.StudyIndividualSample.TBL.getName(), fieldsName);
