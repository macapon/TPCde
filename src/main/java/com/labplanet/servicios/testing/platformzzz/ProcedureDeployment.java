 ...
 */
package com.labplanet.servicios.testing.platformzzz;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)  throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Object[][] procEvent = Rdbms.getRecordFieldsByFilter(procInstanceSchemaProcName, TblsProcedure.ProcedureEvents.TBL.getName(),
                    new String[]{TblsProcedure.ProcedureEvents.FLD_ROLE_NAME.getName()+" is not null"}, new String[]{""}, PROC_DISPLAY_PROC_INSTANCE_REQUIREMENTS_FLD_NAME.split("\\|"),
            ...
            Object[][] procEventSOPStemp = Rdbms.getRecordFieldsByFilter(procInstanceSchemaProcName, TblsProcedure.ProcedureEvents.TBL.getName(),
                    new String[]{TblsProcedure.ProcedureEvents.FLD_SOP.getName()+" is not null"}, new String[]{""}, new String[]{TblsProcedure.ProcedureEvents.FLD_SOP.getName()},
